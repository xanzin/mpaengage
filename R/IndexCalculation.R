...
##library("readxl")
JuanMatrix <- read_excel("inputs/JuanMatrix.xlsx")

# =====================================
#           Habitat 
# =====================================
Habitat <- read_excel("inputs/Habitat.xlsx") # load file
...
#           Users
# =====================================
Users <- read_excel("inputs/Users.xlsx")
...
#           Species
# =====================================
Species <- read_excel("inputs/Species.xlsx")
...
#           SST
# =====================================
SST <- read_excel("inputs/SST.xlsx")
...
#           MWH
# =====================================
MHW <- read_excel("inputs/MHW.xlsx")
...
######################################################################
## save output tables
write.csv (TMHW,     "outputs/TMHW_QI.csv")
write.csv (TSST,     "outputs/TSST_QI.csv")
write.csv (TSpecies, "outputs/TSpecies_QI.csv")
write.csv (TUsers,   "outputs/TUsers_QI.csv")
write.csv (THabitat, "outputs/THabitat_QI.csv")
