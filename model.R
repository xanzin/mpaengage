...
source("shiny/Vulnerability_Index/function_library.R")
...
model_definitions_file <- "shiny/Vulnerability_Index/model definitions.xlsx"
...
## Save Excels
writexl::write_xlsx(MPA_vul, "R/MPA_INDEX_result.xlsx")
writexl::write_xlsx(MPA_cov, "R/MPA_INDEX_coverage.xlsx")
writexl::write_xlsx(MPA_cont, "R/MPA_INDEX_contribution.xlsx")
writexl::write_xlsx(MPA_year, "R/MPA_INDEX_years.xlsx")
writexl::write_xlsx(MPA_quant, "R/MPA_INDEX_quantitative.xlsx")
...
## Save Excels
writexl::write_xlsx(SP_vul,"R/SP_INDEX_result.xlsx")
writexl::write_xlsx(SP_cov,"R/SP_INDEX_coverage.xlsx")
writexl::write_xlsx(SP_cont,"R/SP_INDEX_contribution.xlsx")
writexl::write_xlsx(SP_year,"R/SP_INDEX_years.xlsx")
writexl::write_xlsx(SP_quant,"R/SP_INDEX_quantitative.xlsx")
...
## Save Excels
writexl::write_xlsx(SST_vul,"R/SST_INDEX_result.xlsx")
writexl::write_xlsx(SST_cov,"R/SST_INDEX_coverage.xlsx")
writexl::write_xlsx(SST_cont,"R/SST_INDEX_contribution.xlsx")
writexl::write_xlsx(SST_year,"R/SST_INDEX_years.xlsx")
writexl::write_xlsx(SST_quant,"R/SST_INDEX_quantitative.xlsx")
...
## Save Excels
writexl::write_xlsx(MHW_vul,"R/MHW_INDEX_result.xlsx")
writexl::write_xlsx(MHW_cov,"R/MHW_INDEX_coverage.xlsx")
writexl::write_xlsx(MHW_cont,"R/MHW_INDEX_contribution.xlsx")
writexl::write_xlsx(MHW_year,"R/MHW_INDEX_years.xlsx")
writexl::write_xlsx(MHW_quant,"R/MHW_INDEX_quantitative.xlsx")
...
## Save Excels
writexl::write_xlsx(HB_vul,"R/HB_INDEX_result.xlsx")
writexl::write_xlsx(HB_cov,"R/HB_INDEX_coverage.xlsx")
writexl::write_xlsx(HB_cont,"R/HB_INDEX_contribution.xlsx")
writexl::write_xlsx(HB_year,"R/HB_INDEX_years.xlsx")
writexl::write_xlsx(HB_quant,"R/HB_INDEX_quantitative.xlsx")
...
## Save Excels
writexl::write_xlsx(RA_vul,"R/RA_INDEX_result.xlsx")
writexl::write_xlsx(RA_cov,"R/RA_INDEX_coverage.xlsx")
writexl::write_xlsx(RA_cont,"R/RA_INDEX_contribution.xlsx")
writexl::write_xlsx(RA_year,"R/RA_INDEX_years.xlsx")
writexl::write_xlsx(RA_quant,"R/RA_INDEX_quantitative.xlsx")
...
## Save Excels
writexl::write_xlsx(PF_vul,"R/PF_INDEX_result.xlsx")
writexl::write_xlsx(PF_cov,"R/PF_INDEX_coverage.xlsx")
writexl::write_xlsx(PF_cont,"R/PF_INDEX_contribution.xlsx")
writexl::write_xlsx(PF_year,"R/PF_INDEX_years.xlsx")
writexl::write_xlsx(PF_quant,"R/PF_INDEX_quantitative.xlsx")
...
source("R/IndexCalculation.R") ## READS THE SMITS' CODE
